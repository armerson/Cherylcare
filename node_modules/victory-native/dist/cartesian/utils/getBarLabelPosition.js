...
exports.getBarLabelPosition = void 0;
const getBarLabelPosition = ({ orientation, position, x, y, labelWidth, fontSize, labelRotate = 0, barWidth, chartBounds, baselineX = 0, }) => {
    ...
    if (orientation === "horizontal") {
        ...
        const barHorizontalMidpoint = barInnerLeftEdge + (barOuterRightEdge - barInnerLeftEdge) / 2;
...
exports.getBarLabelPosition = getBarLabelPosition;
const getRotatedLabelOutwardOffset = ({ labelWidth, fontSize, labelRotate, }) => {
    if (!labelRotate || !labelWidth || !fontSize)
        return 0;
    const radians = Math.abs((Math.PI / 180) * labelRotate);
    const rotatedHalfHeight = (Math.abs(labelWidth * Math.sin(radians)) +

...
const makeScale = ({ inputBounds, outputBounds, padStart, padEnd, viewport, isNice = false, axisScale = "linear", }) => {
    ...
    const viewOutputBounds = hasViewport && hasPadding
        ? [outputBounds[0] + (padStart !== null && padStart !== void 0 ? padStart : 0), outputBounds[1] - (padEnd !== null && padEnd !== void 0 ? padEnd : 0)]
        : outputBounds;
    switch (axisScale) {
        case "log": {

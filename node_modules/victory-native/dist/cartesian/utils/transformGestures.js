...
const applyPanTransformGestureConfig_1 = require("./applyPanTransformGestureConfig");
...
const panTransformGesture = (state, _config = {}) => {
    ...
    (0, applyPanTransformGestureConfig_1.applyPanTransformGestureConfig)({ panGesture: pan, panConfig: config });
    return pan;
};

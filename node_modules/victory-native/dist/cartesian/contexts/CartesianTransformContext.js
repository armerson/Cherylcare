...
exports.useCartesianTransformContext = exports.CartesianTransformProvider = exports.CartesianTransformValueProvider = void 0;
const react_1 = __importStar(require("react"));
const react_native_reanimated_1 = require("react-native-reanimated");
const transform_1 = require("../../utils/transform");
const CartesianTransformContext = (0, react_1.createContext)(undefined);
const CartesianTransformValueProvider = ({ value, children, }) => {
    return (<CartesianTransformContext.Provider value={value}>
      {children}
    </CartesianTransformContext.Provider>);
};
exports.CartesianTransformValueProvider = CartesianTransformValueProvider;
const CartesianTransformProvider = ({ transformState, children, }) => {
    ...
    (0, react_native_reanimated_1.useAnimatedReaction)(() => {
        ...
        if (cv.scaleX !== (pv === null || pv === void 0 ? void 0 : pv.scaleX) ||
            cv.scaleY !== pv.scaleY ||
    ...
    return (<exports.CartesianTransformValueProvider value={transform}>
      {children}
    </exports.CartesianTransformValueProvider>);
};

...
exports.buildChartAxis = exports.useBuildChartAxis = void 0;
const react_1 = __importDefault(require("react"));
const axisDefaults_1 = require("../utils/axisDefaults");
/**
 ...
 */
const useBuildChartAxis = (args) => {
    const { axisOptions, xAxis, yAxis, frame, yKeys } = args;
    return react_1.default.useMemo(() => (0, exports.buildChartAxis)({ axisOptions, xAxis, yAxis, frame, yKeys }), [axisOptions, xAxis, yAxis, frame, yKeys]);
};
exports.useBuildChartAxis = useBuildChartAxis;
const buildChartAxis = ({ axisOptions, xAxis, yAxis, frame, yKeys, }) => {
    ...
    const defaultAxisOptions = Object.assign(Object.assign({}, axisDefaults_1.CartesianAxisDefaultProps), axisOptions);
    const xAxisWithDefaults = Object.assign(Object.assign({}, axisDefaults_1.XAxisDefaults), xAxis);
    const yAxisWithDefaults = yAxis
        ? yAxis.length === 1
            ? yAxis.map((axis) => {
                var _a;
                return (Object.assign(Object.assign(Object.assign({}, axisDefaults_1.YAxisDefaults), { yKeys: (_a = axis.yKeys) !== null && _a !== void 0 ? _a : yKeys }), axis));
            })
            : yAxis.map((axis) => (Object.assign(Object.assign({}, axisDefaults_1.YAxisDefaults), axis)))
        : [Object.assign(Object.assign({}, axisDefaults_1.YAxisDefaults), { yKeys })];
    const frameWithDefaults = frame
        ? Object.assign(Object.assign({}, axisDefaults_1.FrameDefaults), frame) : pickFrameProps(defaultAxisOptions);
    return {
...
exports.buildChartAxis = buildChartAxis;
